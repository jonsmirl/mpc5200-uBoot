 ...
 *
 * Configuation settings for the SAMSUNG S5PV210(ARIES) board.
 *
...
#define CFG_PROMPT              "ARIES # "   /* Monitor Command Prompt       */
...
/*
 * ARIES board specific data
 */

#define CONFIG_IDENT_STRING	" for ARIES"
