...
ifeq ($(ARCH),arm)
CROSS_COMPILE = tools/toolchain/arm-eabi-4.4.3/bin/arm-eabi-
endif
ifeq ($(ARCH),i386)
...
mango210_config :	unconfig
	...
	@echo "TEXT_BASE = 0x2fe00000" > $(obj)board/samsung/mango210/config.mk

aries_config :		unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x aries samsung s5pc110
	@echo "TEXT_BASE = 0x2fe00000" > $(obj)board/samsung/aries/config.mk
