...
void LCD_Initialize_LB070WV6(void)
{
	...
	Outp32(0xf8000004, 0x60);		// H, V Invert
	Outp32(0xf8000010, (14<<16)|(16<<8)|(1));	// VSync
	Outp32(0xf8000014, (64<<16)|(64<<8)|(128));	// HSync
	Outp32(0xf8000170, 0x0);		// 8:8:8
	Outp32(0xf8000018, ((LCD_HEIGHT-1)<<11)|(LCD_WIDTH-1));	// Resolution
